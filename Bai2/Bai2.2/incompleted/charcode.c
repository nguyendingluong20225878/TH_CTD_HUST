...
CharCode charCodes[256] = {/* o-> 255*/
  ...
  CHAR_SPACE, CHAR_EXCLAIMATION, CHAR_DOUBLEQUOTE, CHAR_UNKNOWN, CHAR_UNKNOWN, CHAR_PERCENT, CHAR_UNKNOWN, CHAR_SINGLEQUOTE, // Dấu " (34) -> CHAR_DOUBLEQUOTE, Dấu % (37) -> CHAR_PERCENT
