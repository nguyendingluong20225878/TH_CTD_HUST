...
#define MAX_IDENT_LEN 15//chiều dài tối đa cho 1 địn danh
#define KEYWORDS_COUNT 20//tổng số từ khóa định nghĩa trong ngôn ngữ

typedef enum {
  //TK_NONE: không có token
  //TK_IDENT: định danh
  //TK_NUMBER: số
  //TK_CHAR: kí tự
  //TK_EOF: kết thúc file
  //KW_:các từ khóa
  //SB_: các toán tử, dấu câu
...
typedef struct {
  ...
  int lineNo, colNo;
  TokenType tokenType;
  int value;//chỉ dùng cho TK_NUMBER
} Token;
